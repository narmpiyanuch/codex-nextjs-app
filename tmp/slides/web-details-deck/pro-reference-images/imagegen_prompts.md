...
## Slide 01 -> /Users/socket9/Documents/learn-codex-app/tmp/slides/web-details-deck/pro-reference-images/slide-01.png
...
The outline begins with one intro paragraph, followed by exactly 5 slide sections. Each slide section has one title line and one explanatory paragraph. For this request, use only the 1st slide section after the intro paragraph, whose semantic concept is "Website overview and product positioning". Use that concept only for composition and visual subject matter; never render the title or any section text as readable text in the image. Do not use neighboring sections' titles, facts, dates, or examples.

Apply this style guidance to palette, typography feel, layout, icon treatment, density, and tone:
Editorial-tech presentation style for a polished Next.js authentication product. Use warm cream and soft ivory backgrounds, deep ink typography zones, teal accents, muted brass highlights, elegant layered texture, rounded glass-like panels, premium UI atmosphere, and broad negative space for editable text. Keep all visuals text-free and suitable for professional product documentation.
...
## Slide 02 -> /Users/socket9/Documents/learn-codex-app/tmp/slides/web-details-deck/pro-reference-images/slide-02.png
...
Target canvas: 1280x720 16:9. If the image tool offers aspect controls, use a wide 16:9 composition.
The outline begins with one intro paragraph, followed by exactly 5 slide sections. Each slide section has one title line and one explanatory paragraph. For this request, use only the 2nd slide section after the intro paragraph, whose semantic concept is "User journey across the four main screens". Use that concept only for composition and visual subject matter; never render the title or any section text as readable text in the image. Do not use neighboring sections' titles, facts, dates, or examples.
...
## Slide 03 -> /Users/socket9/Documents/learn-codex-app/tmp/slides/web-details-deck/pro-reference-images/slide-03.png
...
Target canvas: 1280x720 16:9. If the image tool offers aspect controls, use a wide 16:9 composition.
The outline begins with one intro paragraph, followed by exactly 5 slide sections. Each slide section has one title line and one explanatory paragraph. For this request, use only the 3rd slide section after the intro paragraph, whose semantic concept is "Authentication and data architecture". Use that concept only for composition and visual subject matter; never render the title or any section text as readable text in the image. Do not use neighboring sections' titles, facts, dates, or examples.
...
## Slide 04 -> /Users/socket9/Documents/learn-codex-app/tmp/slides/web-details-deck/pro-reference-images/slide-04.png
...
Target canvas: 1280x720 16:9. If the image tool offers aspect controls, use a wide 16:9 composition.
The outline begins with one intro paragraph, followed by exactly 5 slide sections. Each slide section has one title line and one explanatory paragraph. For this request, use only the 4th slide section after the intro paragraph, whose semantic concept is "UI/UX design language and page composition". Use that concept only for composition and visual subject matter; never render the title or any section text as readable text in the image. Do not use neighboring sections' titles, facts, dates, or examples.
...
## Slide 05 -> /Users/socket9/Documents/learn-codex-app/tmp/slides/web-details-deck/pro-reference-images/slide-05.png
...
Target canvas: 1280x720 16:9. If the image tool offers aspect controls, use a wide 16:9 composition.
The outline begins with one intro paragraph, followed by exactly 5 slide sections. Each slide section has one title line and one explanatory paragraph. For this request, use only the 5th slide section after the intro paragraph, whose semantic concept is "Delivery readiness, quality checks, and roadmap". Use that concept only for composition and visual subject matter; never render the title or any section text as readable text in the image. Do not use neighboring sections' titles, facts, dates, or examples.
